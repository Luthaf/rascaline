...
/// as the computation of neighbor lists.
///
/// `System` also allows calculator to store arbitrary data inside the system
/// (to be used a a cache between different function calls in the
/// `CalculatorBase` trait).
pub struct System {
