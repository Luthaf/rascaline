...
get_filename_component(RASCALINE_PREFIX_DIR "${CMAKE_CURRENT_LIST_DIR}/@PACKAGE_RELATIVE_PATH@" ABSOLUTE)

if (WIN32)
    set(RASCALINE_SHARED_LOCATION ${RASCALINE_PREFIX_DIR}/@BIN_INSTALL_DIR@/@RASCALINE_SHARED_LIB_NAME@)
    set(RASCALINE_IMPLIB_LOCATION ${RASCALINE_PREFIX_DIR}/@LIB_INSTALL_DIR@/@RASCALINE_IMPLIB_NAME@)
else()
    set(RASCALINE_SHARED_LOCATION ${RASCALINE_PREFIX_DIR}/@LIB_INSTALL_DIR@/@RASCALINE_SHARED_LIB_NAME@)
endif()

set(RASCALINE_STATIC_LOCATION ${RASCALINE_PREFIX_DIR}/@LIB_INSTALL_DIR@/@RASCALINE_STATIC_LIB_NAME@)
set(RASCALINE_INCLUDE ${RASCALINE_PREFIX_DIR}/@INCLUDE_INSTALL_DIR@/)
