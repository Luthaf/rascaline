...
#error "rascaline C++ API is not yet available"
...
//             std::memset(&options.selected_samples, 0, sizeof(eqs_labels_t));
//         } else {
...
//             std::memset(&options.selected_properties, 0, sizeof(eqs_labels_t));
//         } else {
//             options.selected_properties.names = this->selected_features.names().data();
//             options.selected_properties.values = this->selected_features.data();
//             options.selected_properties.count = this->selected_features.count();
//             options.selected_properties.size = this->selected_features.size();
//         }
