"""
Private module containing helper functions for public modules
:py:mod:`correlate_tensors` and :py:mod:`correlate_density` that compute
Clebsch-gordan tensor products on metatensor :py:class:`TensorMap` objects.
"""
import itertools
