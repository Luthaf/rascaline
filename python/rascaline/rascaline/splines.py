...
class SoapSpliner:
    ...
    If ``density`` is either :class:`rascaline.density.Delta` or
    :class:`rascaline.density.Gaussian` the radial integral will be partly solved
    ...
    >>> cutoff = rascaline.cutoff.Cutoff(radius=2, smoothing=None)
    >>> density = rascaline.density.Gaussian(width=1.0)
    >>> basis = rascaline.basis.TensorProduct(
    ...     max_angular=4,
    ...     radial=rascaline.basis.Gto(max_radial=5, radius=2),
    ...
    >>> calculator = rascaline.SphericalExpansion(**spliner.get_hypers())
    ...
    def _ri_gaussian_density(
        ...
        # https://luthaf.fr/rascaline/latest/devdoc/explanations/radial-integral.html,
...
class LodeSpliner:
    ...
    :class:`rascaline.LodeSphericalExpansion`. For real space spherical expansions you
    ...
    >>> density = rascaline.density.SmearedPowerLaw(smearing=1.0, exponent=1)
    >>> basis = rascaline.basis.TensorProduct(
    ...     max_angular=4,
    ...     radial=rascaline.basis.Gto(max_radial=5, radius=2),
    ... )
    ...
    >>> calculator = rascaline.LodeSphericalExpansion(**spliner.get_hypers())
