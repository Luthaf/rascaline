...
from rascaline.utils.clebsch_gordan import EquivariantPowerSpectrum
...
def test_equivariant_power_spectrum_vs_powerspectrum(frames):
    ...
    EquivariantPowerSpectrum the Python implementation of PowerSpectrum in rascaline
    utils.
    """
    ...
    ps_2 = EquivariantPowerSpectrum(*SPHEX_HYPERS_SMALL).compute(
        frames,
    ...
    assert metatensor.allclose(ps_1, ps_2)
...
def test_equivariant_power_spectrum_neighbors_to_properties(frames):
    ...
    """
    # Build an EquivariantPowerSpectrum
    powspec_calc = EquivariantPowerSpectrum(*SPHEX_HYPERS_SMALL)
    ...
    powspec_1.keys_to_properties(["neighbor_1_type", "neighbor_2_type"])
